(function (window, document) {
  ...
  if (
    ...
    var files = ["http://s7aero.beget.tech/verstka/img/symbol_sprite.html"],
      revision = 9;
...
jQuery(function($){
  $('.slct').each(function(e){
    if ($(this).text() == ''){
      $(this).parent().addClass('slct-not')
    }else{
      $(this).parent().removeClass('slct-not')
    }
  })
...
document.addEventListener("DOMContentLoaded", () => {
  // const input = document.querySelector('.search-input-placeholder-js');
